...
# Load Model
MODEL_PATH = r"C:\Users\Gamer Tech\Desktop\FYP\models\RFC.pkl"
with open(MODEL_PATH, "rb") as file:
    RFC = pickle.load(file)

# Load Data
symptom_description = pd.read_csv(r"C:\Users\Gamer Tech\Desktop\FYP\Data\symptoms_df.csv").drop(columns=['Unnamed: 0'], errors='ignore')
precaution = pd.read_csv(r"C:\Users\Gamer Tech\Desktop\FYP\Data\precautions_df.csv").drop(columns=['Unnamed: 0'], errors='ignore')
...
# Symptom Dictionary & Disease Mapping
...
selected_symptoms = st.multiselect("Choose symptoms", list(symptoms_dict.keys()))
...
if st.button("Predict Disease"):
    if len(selected_symptoms) < 1:
        ...
        desc, pre, med, die = helper(disease)

        # Display Results
        st.success(f"### Predicted Disease: {disease}")
        st.write(f"**📝 Description:** {desc if desc else 'No description available.'}")
...
# Footer
st.write("Developed by **Muhammad Zulkifl** 🎓")
